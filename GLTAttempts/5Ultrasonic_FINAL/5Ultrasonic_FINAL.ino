...
unsigned int trigPin5 = 48;
unsigned int echoPin5 = 50;
...
unsigned int pinArray[num_sensor] = {trigPin1, trigPin2, trigPin3, trigPin4, trigPin5};
unsigned int echoPinArray[num_sensor] = {echoPin1, echoPin2, echoPin3, echoPin4, echoPin5};
